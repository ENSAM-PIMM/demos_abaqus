...
#----------------------------------------------------------------------------
param=dict()
param['idim']= 3                       # flag: 2 (plane stress) or 3 (3D)
param['dim']=[50.e-3,50.e-3,5.e-3]     # dimensions of sample
param['rad']= 5.e-3                    # radius of the hole
param['selt']=[1.0e-3, 0.1]            # element size
param['quad']=False                    # linear/quadratic elements
param['load']=[1.e-3,0.e-3]            # applied displacement in X- & Y- direction
param['run']=False                     # run
...
s.Line(point1=(0.0, param['rad']), point2=(0.0, param['dim'][1]/2.))
s.Line(point1=(0.0, param['dim'][1]/2.), point2=(param['dim'][0]/2., param['dim'][1]/2.))
s.Line(point1=(param['dim'][0]/2., param['dim'][1]/2.), point2=(param['dim'][0]/2., 0.))
s.Line(point1=(param['dim'][0]/2., 0.), point2=(param['rad'], 0.))
s.ArcByCenterEnds(center=(0.0, 0.0), point1=(0.0, param['rad']), point2=(param['rad'], 0.),  direction=CLOCKWISE)
if param['idim']==3 :
